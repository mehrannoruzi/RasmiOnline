 ...
 *  EnZebra_DatePicker
 *
 *  EnZebra_DatePicker is a small, compact and highly configurable date picker / time picker jQuery plugin
 *
 *  Read more {@link https://github.com/stefangabos/EnZebra_DatePicker/ here}
 *
 *  @author     Stefan Gabos <contact@stefangabos.ro>
 *  @version    1.9.11 (last revision: September 19, 2018)
 *  @copyright  (c) 2011 - 2018 Stefan Gabos
 *  @license    http://www.gnu.org/licenses/lgpl-3.0.txt GNU LESSER GENERAL PUBLIC LICENSE
 *  @package    EnZebra_DatePicker
 */
(function (factory) {
    ...
    $.EnZebra_DatePicker = function (element, options) {
        ...
        var defaults = {
            ...
            //
            //  .EnZebra_DatePicker .dp_daypicker td.myclass1 { .. }
            //  .EnZebra_DatePicker .dp_daypicker td.myclass1_disabled { .. }
            //
            ...
            //  if set as a jQuery element with a EnZebra_DatePicker attached, that particular date picker will use the
        ...
        var init = function (update) {
            ...
            if (!update) {
                ...
                plugin.settings = $.extend({}, defaults, $.fn.EnZebra_DatePicker.defaults, options);
            ...
            if (!(plugin.settings.always_visible instanceof jQuery)) {
                ...
                if (!update) {
                    ...
                    if (plugin.settings.show_icon) {
                        ...
                        var marginTop = parseInt($element.css('marginTop'), 10) || 0,
                            ...
                            icon_wrapper = $('<span class="EnZebra_DatePicker_Icon_Wrapper"></span>').css({
                        ...
                        icon = $('<button type="button" class="EnZebra_DatePicker_Icon' + ($element.attr('disabled') === 'disabled' ? ' EnZebra_DatePicker_Icon_Disabled' : '') + '">Pick a date</button>');
                    ...
                    clickables.on('click.EnZebra_DatePicker_' + uniqueid + (plugin.settings.open_on_focus ? ' focus.EnZebra_DatePicker_' + uniqueid : ''), function () {
                    ...
                    clickables.on('keydown.EnZebra_DatePicker_' + uniqueid, function (e) {
                    ...
                    if (!plugin.settings.readonly_element && plugin.settings.pair)
                        ...
                        $element.on('blur.EnZebra_DatePicker_' + uniqueid, function () {
                ...
                if (undefined !== icon) {
                    ...
                    icon.removeClass('EnZebra_DatePicker_Icon_Disabled');

                    // if element the datepicker is attached to became disabled, disable the calendar icon, too
                    if ($element.attr('disabled') === 'disabled') icon.addClass('EnZebra_DatePicker_Icon_Disabled');
            ...
            $(window).on('resize.EnZebra_DatePicker_' + uniqueid + ', orientationchange.EnZebra_DatePicker_' + uniqueid, function () {
            ...
            var html = '' +
                '<div class="EnZebra_DatePicker">' +
                    '<table class="dp_header dp_actions">' +
                        '<tr>' +
                            '<td class="dp_previous">' + plugin.settings.navigation[1] + (is_iOS ? '&#xFE0E;' : '') + '</td>' +
                            '<td class="dp_caption"></td>' +
                            '<td class="dp_next">' + plugin.settings.navigation[0] + (is_iOS ? '&#xFE0E;' : '') + '</td>' +
                        '</tr>' +
                    '</table>' +
            ...
            if (!(plugin.settings.always_visible instanceof jQuery)) {
                ...
                $(document).on('touchmove.EnZebra_DatePicker_' + uniqueid, function () {
                ...
                $(document).on('mousedown.EnZebra_DatePicker_' + uniqueid + ' touchend.EnZebra_DatePicker_' + uniqueid, function (e) {
                    ...
                    if (
                        ...
                        $(e.target).parents().filter('.EnZebra_DatePicker').length === 0
                ...
                $(document).on('keyup.EnZebra_DatePicker_' + uniqueid, function (e) {
        ...
        plugin.destroy = function () {
            ...
            if (undefined !== plugin.icon) {
                ...
                plugin.icon.off('click.EnZebra_DatePicker_' + uniqueid);
                plugin.icon.off('focus.EnZebra_DatePicker_' + uniqueid);
                plugin.icon.off('keydown.EnZebra_DatePicker_' + uniqueid);
            ...
            $element.off('blur.EnZebra_DatePicker_' + uniqueid);
            $element.off('click.EnZebra_DatePicker_' + uniqueid);
            $element.off('focus.EnZebra_DatePicker_' + uniqueid);
            $element.off('keydown.EnZebra_DatePicker_' + uniqueid);
            $element.off('mousedown.EnZebra_DatePicker_' + uniqueid);

            // remove associated event handlers from the document
            $(document).off('keyup.EnZebra_DatePicker_' + uniqueid);
            $(document).off('mousedown.EnZebra_DatePicker_' + uniqueid);
            $(document).off('touchend.EnZebra_DatePicker_' + uniqueid);
            $(window).off('resize.EnZebra_DatePicker_' + uniqueid);
            $(window).off('orientationchange.EnZebra_DatePicker_' + uniqueid);

            // remove association with the element
            $element.removeData('EnZebra_DatePicker');
        ...
        var update_dependent = function (date) {
            ...
            if (plugin.settings.pair)
                ...
                $.each(plugin.settings.pair, function () {
                    ...
                    // chances are that in the beginning the pair element doesn't have the EnZebra_DatePicker attached to it yet
                    // (as the "start" element is usually created before the "end" element)
                    // so we'll have to rely on "data" to send the starting date to the pair element

                    // therefore, if EnZebra_DatePicker is not yet attached
                    if (!($pair.data && $pair.data('EnZebra_DatePicker')))

                        // set the starting date like this
                        $pair.data('zdp_reference_date', date);

                        // if EnZebra_DatePicker is attached to the pair element
                    else {

                        // reference the date picker object attached to the other element
                        dp = $pair.data('EnZebra_DatePicker');
    ...
    $.fn.EnZebra_DatePicker = function (options) {

        // iterate through all the elements to which we need to attach the date picker to
        return this.each(function () {

            // if element has a date picker already attached
            if (undefined !== $(this).data('EnZebra_DatePicker'))

                // remove the attached date picker
                $(this).data('EnZebra_DatePicker').destroy();

            // create an instance of the plugin
            var plugin = new $.EnZebra_DatePicker(this, options);

            // save a reference to the newly created object
            $(this).data('EnZebra_DatePicker', plugin);
    ...
    $.fn.EnZebra_DatePicker.defaults = {};
