...
var getPriceItems = function (templateId, succesFunc, failedFunc) {
    if (templateId > 0) {
        $.ajax({
            url: 'http://panel.RasmiOnline.com/PricingItem/GetPricingItemTable?templateId=' + templateId,
            data: JSON.stringify({}),
            type: 'GET',
...
var getPriceItemsWithCategoryId = function (categoryId, succesFunc, failedFunc) {
    if (categoryId > 0) {
        ...
        $.ajax({
            url: 'http://panel.RasmiOnline.com/PricingItem/GetPricingItemTableWithCategoryId?categoryId=' + categoryId,
            data: JSON.stringify({}),
            type: 'GET',
            contentType: 'text/html'
        })
...
var getPricingItemAccordion = function (succesFunc, failedFunc) {
    $.ajax({
        url: 'http://panel.RasmiOnline.com/PricingItem/GetPricingItemAccordion',
        data: JSON.stringify({}),
        type: 'GET',
        contentType: 'text/html'
    })
...
//    $.ajax({
//        url: 'http://panel.RasmiOnline.com/Channel/Visit',
