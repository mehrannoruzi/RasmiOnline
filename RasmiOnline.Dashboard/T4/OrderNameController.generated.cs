...
{
    public partial class OrderNameController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected OrderNameController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public OrderNameController Actions { get { return MVC.OrderName; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "OrderName";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "OrderName";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public partial class _PartialsClass
            {
                ...
                public class _ViewNamesClass
                {
                    public readonly string _OrderName = "_OrderName";
                    public readonly string _ShowItem = "_ShowItem";
                }
                public readonly string _OrderName = "~/Views/OrderName/Partials/_OrderName.cshtml";
                public readonly string _ShowItem = "~/Views/OrderName/Partials/_ShowItem.cshtml";
            }
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_OrderNameController : RasmiOnline.Dashboard.Controllers.OrderNameController
    {
        public T4MVC_OrderNameController() : base(Dummy.Instance) { }

        [NonAction]
        partial void AddOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, RasmiOnline.Domain.Entity.OrderName model);

        [NonAction]
        public override System.Web.Mvc.JsonResult Add(RasmiOnline.Domain.Entity.OrderName model)
        {
