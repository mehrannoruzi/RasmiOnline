...
namespace RasmiOnline.Dashboard.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_UserController : RasmiOnline.Dashboard.Controllers.UserController
    {
        ...
        [NonAction]
        partial void ProfileOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, RasmiOnline.Dashboard.ProfileModel model);

        [NonAction]
        public override System.Web.Mvc.JsonResult Profile(RasmiOnline.Dashboard.ProfileModel model)
        {
